...
class Player(tk.Frame):
    ...
    def create_frames(self):
        self.track = tk.LabelFrame(self, text='Song Track', font=("algerian",15,"bold"),
    ...
    def track_widgets(self):
        ...
        self.songtrack = tk.Label(self.track, font=("times new roman",16,"bold"),bg="WHITE",fg="BLACK")
        self.songtrack['text'] = 'MUSIC PLAYER'
        self.songtrack.config(width=20, height=1)
        self.songtrack.grid(row=1,column=0,padx=10)
    
    def control_widgets(self):
        self.loadSongs = tk.Button(self.controls, bg='brown', fg='white', font=8)
        self.loadSongs['text'] = 'Load Songs'
        self.loadSongs['command'] = self.retrieve_songs
        self.loadSongs.grid(row=0, column=0, padx=8)
